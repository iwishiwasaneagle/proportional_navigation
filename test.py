...
class TestExceptions(unittest.TestCase):
    def test_invalidPNGainInput(self):
        with self.assertRaises(PN.InvalidProportionalGainError):
            PN.PN(PN.Body(0,0,0,0),PN.Body(0,0,0,0),0)

        with self.assertRaises(TypeError):
            PN.PN(PN.Body(0,0,0,0),PN.Body(0,0,0,0),"str")

    def test_invalidBodies(self):
        with self.assertRaises(TypeError):
            PN.PN("str",PN.Body(0,0,0,0),1)
        with self.assertRaises(TypeError):
            PN.PN(PN.Body(0,0,0,0),"str",1)
    
    def test_invalidPNOptions(self):
        with self.assertRaises(TypeError):
            PN.PN(PN.Body(0,0,0,0),PN.Body(0,0,0,0),1,options="str")

    def test_sameCoords(self):
        with self.assertRaises(PN.OutOfBoundsRangeError):
            PN.PN(PN.Body(0,0,0,0),PN.Body(0,0,0,0)).calculate()
...
class TestPNOptions(unittest.TestCase):
    ...
    def test_optionsWork(self):
        ...
        ret1 = PN.PN(PN.Body(10,1,0,0),PN.Body(0,10,10,0),options=opt1).calculate()
        ...
        ret2 = PN.PN(PN.Body(10,1,0,0),PN.Body(0,10,10,0),options=opt2).calculate()
        ...
        ret3 = PN.PN(PN.Body(10,1,0,0),PN.Body(0,10,10,0)).calculate()
